...
public class Tile : MonoBehaviour
{
    ...
    private void OnMouseDown()
    {
        ...
        if (isCreatable == true && gm.createdUnit != null)
        {
            ...
            Pathfinding.grid.NodeFromWorldPoint(unit.transform.position).walkable = false;
            Pathfinding.grid.NodeFromWorldPoint(unit.transform.position).hasUnit = true;
            unit.hasMoved = true;
        ...
        else if (isCreatable == true && gm.createdVillage != null)
        {
            ...
            Pathfinding.grid.NodeFromWorldPoint(village.transform.position).walkable = false;
            gm.ResetTiles();
